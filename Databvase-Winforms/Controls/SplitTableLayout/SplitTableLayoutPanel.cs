...
namespace Databvase_Winforms.Controls.SplitTableLayout
{
    //SOURCE: https://stackoverflow.com/questions/31069443/how-to-make-tablelayoutpanel-with-resizable-cells-like-using-splitter
    //THANKS STEVE-E 
    public partial class SplitTableLayoutPanel : TableLayoutPanel
    {
        ...
        {   // change the height of one row
            ...
            if (newHeight > 0)
                ...
                if (RowStyles.Count >= sizingRow + 1)
                {
